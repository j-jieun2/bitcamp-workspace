...
public class SqlSessionFactoryProxy implements SqlSessionFactory {
  ...
  public void endTransaction() {
    ...
    // 이전에 commit()/rollbak() 을 호출하여 트랜잭션을 종료한 상태라면
    // 다음 작업을 수행할 필요가 없다.8
