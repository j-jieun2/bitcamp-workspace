...
CREATE TABLE lms_mgr (
	...
	pno INTEGER     NULL     COMMENT '직급번호', -- 직급번호
...
-- 사용자 인덱스2
CREATE INDEX IX_lms_user2
	ON lms_user( -- 사용자
		email ASC -- 이메일
	);

-- 사용자 인덱스3
CREATE INDEX IX_lms_user3
	ON lms_user( -- 사용자
		jumin ASC -- 주민번호
	);
...
CREATE TABLE lms_major (
	majno INTEGER     NOT NULL COMMENT '전공번호', -- 전공번호
	title VARCHAR(50) NOT NULL COMMENT '전공' -- 전공
)
COMMENT '전공';
...
CREATE TABLE lms_center (
	cenno INTEGER     NOT NULL COMMENT '지점번호', -- 지점번호
	title VARCHAR(50) NULL     COMMENT '센터명' -- 센터명
)
COMMENT '지점';
...
CREATE TABLE lms_room_photo (
	rhno     INTEGER      NOT NULL COMMENT '교실사진번호', -- 교실사진번호
...
ALTER TABLE lms_room_photo
	MODIFY COLUMN rhno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교실사진번호';
...
CREATE TABLE lms_dept (
	...
	cenno INTEGER     NULL     COMMENT '지점번호', -- 지점번호
	title VARCHAR(50) NULL     COMMENT '부서명' -- 부서명
)
COMMENT '부서';
...
CREATE TABLE lms_addr (
	...
	pstno    VARCHAR(6)   NULL     COMMENT '우편번호', -- 우편번호
