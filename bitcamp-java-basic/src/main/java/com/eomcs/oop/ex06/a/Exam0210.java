...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    /*
    v1.cc = 1980; // Car의 인스턴스 변수, 컴파일 오류
    v1.value = 16; // Car의 인스턴스 변수, 컴파일 오류
    v1.sunroof = true; // Sedan의 인스턴스 변수, 컴파일 오류
    v1.auto = true; // Sedan의 인스턴스 변수, 컴파일 오류
    */

    // 그럼에도 불구하고 레퍼런스가 실제로 가르키는 객체의 모든 메모리에 접근하고 싶은가?
    // => 그럼 형변환 하라!
