...
public class Exam0210 {
  ...
  static void m1() { // void = retrun type / m1 = 메서드명 / () = 아규먼트(argumont)
  ...
  static void m8(String name, int... scores) { // 가변 파라미터
    int sum = 0;
    for (int i = 0; i < scores.length; i++) {
      sum += scores[i];
    }
  ...
  // static void m9(int...int scores, String name) {
  // 가변 파라미터는 무조건 맨 끝에 와야한다.
  // }

  // static void m9(int...int scores, int... scores2) {
