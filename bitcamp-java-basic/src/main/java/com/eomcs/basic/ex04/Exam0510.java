...
public class Exam0510 {
  public static void main(String[] args) {
    int[] p = new int[3]; // c 언어 => (int*)malloc(sizeof(int) * 3) 
    // p
    // - int 배열의 주소를 담는 변수이다.
    // - 자바에서는 주소를 담는 변수를 보통 레퍼런스'라 부른다.
    // 
    // new int[3]
    ...
    // 자바에는 primitive type을 제외한 모든 변수는 레퍼런스이다.
    byte b;
    short s;
    int i;
    long l;
   ...
   //  System.out.println(k1); // 변수를 초기화시키지 않고 사용하면 컴파일 오류!
    ...
    int[] x1 = new int[3]; // 2000 주소
    int[] x2 = new int[4]; // 3000 주소
    int[] x3 = x1; // 2000 주소를 가짐
