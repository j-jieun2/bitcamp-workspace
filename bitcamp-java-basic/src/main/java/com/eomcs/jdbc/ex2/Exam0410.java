...
public class Exam0410 {
  public static void main(String[] args) throws Exception {
    ...
    try (Connection con = DriverManager.getConnection(
        ...
        // 게시글 입력 처리 객체
        PreparedStatement boradStmt = con.prepareStatement(
      ...
      // 게시글 입력
      boradStmt.setString(1, title);
      boradStmt.setString(2, contents);
      int count = boradStmt.executeUpdate();
      ...
      for (String filename : files) {
        ...
        // 그래서 처뭅파일 테이블에 데이터를 입력할 수 없다!
        // 해결책!
        // - 데이터를 입력할 때 자동으로 생성된 PK 값을 알 수 있다면
        //   이 문제를 해결할 수 있다.
        // - 다음 예제를 확인해보라!
