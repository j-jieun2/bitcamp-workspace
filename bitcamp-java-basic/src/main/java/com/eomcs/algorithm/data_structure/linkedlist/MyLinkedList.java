...
//11) 제네릭을 적용한다.
//
public class MyLinkedList<E> { // 타입 파라미터 선언
...
//      Class<?> arrayItemClassInfo = arrayClassInfo.getCompponentType();
//      arr =(E[]) Array.newInstance(arr.getClass(), size);
      arr = (E[]) Array.newInstance(arr.getClass().getComponentType(), this.size());
    } // 받은 배열이 크기가 작다면 크기를 늘려라.
