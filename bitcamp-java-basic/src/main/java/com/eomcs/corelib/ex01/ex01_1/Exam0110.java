...
package com.eomcs.corelib.ex01.ex01_1;
...
public class Exam0110 /*extends Object*/ {
  ...
  public static void main(String[] args) {
    ...
    // My클래스가 Object 클래스의 서브 클래스임을 증명하는 것이다.
    ...
    System.out.println(obj.toString()); // com.eomcs.corelib.ex01.Exam0110$My 소속된 경로를 표시, @a09ee92 16진수
    System.out.println(obj.hashCode()); // 16진수 @a09ee92 => 10진수 168423058
