...
public class Exam0141 {
  public static void main(String[] args) {
    ...
    // 수퍼 클래스에 담게되면 수퍼클래스의 메소드만 호출할 수 있다.
    // 메소드를 호출할 때는 실제 클레스에 있는것부터 찾아 올라간다.

    String x1 = (String) obj; // x1 <= 100

    // obj에 대해 toString()을 호출할 때,
    // => 일단 obj의 클래스에 선언된 멤버(필드와 메서드)만 사용할 수 있다.
    // => 단 멤버는 실제 obj가 가르키는 클래스부터 찾아 올라 간다.
    // => 위 예에서 obj가 가리키는 것은 실제 String 객체 이기 때문에
