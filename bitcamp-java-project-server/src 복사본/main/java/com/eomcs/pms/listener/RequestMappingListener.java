...
public class RequestMappingListener implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String,Object> context) {
    try {
      ...
      //      // 테스트 용 로그인 사용자 정보
      //      Member member = memberService.get("ee@test.com", "1111");
      ...
      commandMap.put("/task/add", new TaskAddCommand(taskService, memberService, projectService));
      ...
      // 커맨드 객체만 모아놓은 상자를 context 맵이라는 큰 상자에 담는다.
