...
public class BoardUpdateCommand implements Command {
  ...
  public void execute(Request request) {
    ...
    try {
      ...
      board.setTitle(Prompt.inputString(String.format("제목(%s)? ", board.getTitle()), out, in));
      board.setContent(Prompt.inputString(String.format("내용(%s)? ", board.getContent()), out, in));
