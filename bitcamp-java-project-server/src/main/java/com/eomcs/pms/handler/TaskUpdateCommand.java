...
public class TaskUpdateCommand implements Command {
  ...
  public TaskUpdateCommand(TaskService taskService, ProjectService projectService,
      MemberService memberService) {
  ...
  public void execute(Request request) {
    ...
    try {
      ...
      // 작업 정보 변경
      task.setContent(Prompt.inputString(String.format("내용(%s)? ", task.getContent()), out, in));
      task.setDeadline(Prompt.inputDate(String.format("마감일(%s)? ", task.getDeadline()), out, in));
